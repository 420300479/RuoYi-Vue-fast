 ...
 * @date 2022-09-18
 */
public class TbFruit2 extends BaseEntity
{
    ...
    public void setDeform(BigDecimal deform) 
    {
        this.deform = deform;
    }

    public BigDecimal getDeform() 
    {
        return deform;
    }
